...
import static com.eleganzit.vkcvendor.ReminderActivity.launchIntent;
...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public static void setReminderAlarm(Context context, Alarm alarm, int notificationId) {
    ...
    public static void cancelReminderAlarm(Context context, Alarm alarm, int notificationId) {
